<?php
/**
 * Title: Blockify Pricing 2
 * Slug: blockify/pricing-2
 * Categories: pricing
 * 
 */
...
<div class="wp-block-button is-style-transparent is-style-secondary"><a class="wp-block-button__link wp-element-button">Get Started</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
