...
<!-- wp:group {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|sm","top":"var:preset|spacing|xs"}}},"layout":{"contentSize":"600px","type":"constrained"}} -->
<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--xs);margin-bottom:var(--wp--preset--spacing--sm)"><!-- wp:paragraph {"align":"center"} -->
