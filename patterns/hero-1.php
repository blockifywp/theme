<?php
/**
 * Title: Blockify Hero 1
 * Slug: blockify/hero-1
 * Categories: hero
 * 
 */
...
<h1 class="alignfull has-text-align-center has-neutral-900-color has-text-color has-72-font-size alignfull">Create your website with easy to use blocks</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"neutral-600","className":"has-text-align-center"} -->
<p class="has-text-align-center has-neutral-600-color has-text-color">Lightweight full site editing theme with a powerful design framework for building modern WordPress sites with blocks.</p>
<!-- /wp:paragraph -->
