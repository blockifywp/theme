...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--xxs);padding-bottom:var(--wp--preset--spacing--xxs);text-decoration:none"><!-- wp:avatar {"size":32,"isLink":true,"style":{"border":{"radius":"99px"}}} /-->
