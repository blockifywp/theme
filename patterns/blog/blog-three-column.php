...
<!-- wp:query {"queryId":0,"query":{"perPage":3,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"displayLayout":{"type":"flex","columns":3},"align":"wide","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|sm","top":"0"},"blockGap":"1.5em"}},"layout":{"inherit":false}} -->
<div class="wp-block-query alignwide" style="padding-top:0;padding-bottom:var(--wp--preset--spacing--sm)"><!-- wp:post-template -->
