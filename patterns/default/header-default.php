...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--sm);padding-bottom:var(--wp--preset--spacing--sm)"><!-- wp:site-logo {"width":120,"shouldSyncIcon":false} /-->
...
<div class="wp-block-group is-reverse-on-mobile is-reverse-mobile"><!-- wp:navigation {"ref":152,"icon":"menu","layout":{"type":"flex","justifyContent":"right","flexWrap":"nowrap"},"style":{"spacing":{"margin":{"left":"var:preset|spacing|md"}},"typography":{"fontSize":"16px"}}} /-->
