...
<div class="wp-block-group alignwide alignwide" id="pricing"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"top":"0.5em"}}}} -->
<h2 class="has-text-align-center" style="margin-top:0.5em">Simple pricing plans</h2>
<!-- /wp:heading -->
