<?php
/**
 * Title: Blockify Header Default
 * Slug: blockify/header-default
 * Categories: header
...
<div class="wp-block-group is-reverse-mobile"><!-- wp:navigation {"layout":{"type":"flex","justifyContent":"right","flexWrap":"nowrap"}} /-->
