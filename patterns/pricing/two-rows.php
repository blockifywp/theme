...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|sm"}}}} -->
<p style="margin-bottom:var(--wp--preset--spacing--sm)">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
<!-- /wp:paragraph -->
...
<!-- wp:list-item -->
<li><span style="color: var(--wp--preset--color--neutral-600); font-family: var(--wp--preset--font-family--sans-serif); font-size: var(--wp--preset--font-size--20); font-weight: var(--wp--custom--font-weight--regular);">Pro membership</span></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
