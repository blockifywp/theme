...
<div class="wp-block-column"><!-- wp:image {"align":"center","id":125,"width":75,"height":75,"sizeSlug":"large","linkDestination":"none","className":"is-style-rounded","textColor":"neutral-200"} -->
<figure class="wp-block-image aligncenter size-large is-resized is-style-rounded has-neutral-200-color has-text-color aligncenter"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/svg/avatar.svg" alt="" class="wp-image-125" width="75" height="75"/></figure>
<!-- /wp:image -->
